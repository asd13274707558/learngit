...
insert into product (pname,cid,pno,pic,price,online,pdetail) values('安踏',10,'a001','大撒旦',100.0 ,1,'阿萨德');
update product set pname='倒萨',cid=23 where id=1;
delete from product where id=2;
select * from product where id=?;


update Cate set cname='衣服',pid=0 where cid=1
select  cid,cname from cate where pid=0;
select * from product
--	重置
