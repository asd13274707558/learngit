...
<html>
	...
	<body>
		...
		<label  for="" class="form-group form-inline">添加子类:</label>
	<input type="text"   name="addzname" class="form-control input-sm " placeholder="例:安踏男装"//>
	<label for="" class="form-group form-inline">添加父类:</label>
		...
		<div class="form-group">
				<button type="submit" class="btn-danger btn" onclick="_tijiao()" >提交</button>
